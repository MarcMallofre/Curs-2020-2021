...
function mostrarProducte($id){
    ...
    if($resultado->num_rows>=0){
       while($producte=$resultado->fetch_assoc()){
           ...
           $llistaProductes.="ID: ".$producte["id"]." Nom: ".$producte["nom"]." Descripcio: ".$producte["descripcio"]." Preu: ".$producte["preu"]." Categories: ".$categoria."<a href='editarProducte.php?id=$idProducte'>Editar</a>"."  "."<a href='borrarProducte.php?borrarProducte=$idProducte'>Borrar</a>"."<br>".$imatges."<br>";
        }
    }
