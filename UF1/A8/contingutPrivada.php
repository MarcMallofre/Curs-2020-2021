...
if (isset($_SESSION["email"])){
    echo "<a href=publica.php>Ves a la pàgina principal</a>"."<br><br>";
    echo "Benvingut "."<br><br>";  
}else{
    header("location:publica.php");
}
...
if($_SESSION["admin"]){
    ...
    //Si qui ha iniciat sessió no és admin, se li mostrarà unicament la opció d'editar les seves dades i es llistaran els seus productes.
}else{
    echo $_SESSION["admin"];
    $id=$_SESSION["id"];
    echo "Els teus productes"."<br><br>";
    echo $llistaProductes=mostrarProducte($id);
    echo "<a href='editar.php'>Editar datos</a>"."<br>"."<br>";
    echo "<a href='altaProducte.php'>Pujar productes</a>";
