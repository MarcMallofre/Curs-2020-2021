...
<script>
    function check(){
        if(!document.forms[0].email.value.length>0){
            ...
            location.href="email.php?email="+document.forms[0].email.value;
        }
    }

</script>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-9CZMN0SDPV"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9CZMN0SDPV');
</script>
</head>
<body>
<div id="cookies">
